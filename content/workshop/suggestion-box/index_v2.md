...
2. [Creating a Suggestion Box App](#creating-a-suggestion-box-app)
  * [Create an App and a Custom Object](#step-1-create-an-app-and-a-custom-object)
  * [Tour the App](#step-2-tour-the-app)
3. [Adding Custom Fields](#adding-custom-fields)
  * [Add a Description field](#step-1-add-a-description-field)
  * [Add a Category Field](#step-2-add-a-category-field)
  * [Try Out the App](#step-3-try-out-the-app)
  * [Viewing Objects in Schema Builder](#step-4-viewing-objects-in-schema-builder)
  * [Add a Status field](#step-5-add-a-status-field)
  * [Add a Date field](#step-6-add-a-date-field)
4. [Modifying the User Experience](#modifying-the-user-experience)
  * [Modify the Page Layout](#step-1-modify-the-page-layout)
  * [Add a Compact Layout](#step-2-add-a-compact-layout)
  * [Add a Global Action](#step-3-add-a-global-action)
5. [Adding Business Logic](#adding-business-logic)
  * [Add a Formula Field](#step-1-add-a-formula-field)
  * [Add a Validation Rule](#step-2-add-a-validation-rule)
  * [Add a Field Update Using Process Builder](#step-3-add-a-field-update-using-process-builder)
6. [Creating Reports and Dashboards](#creating-reports-and-dashboards)
  * [Create a Tabular Report](#step-1-create-a-tabular-report)
  * [Create a Summary Report and a Report Chart](#step-2-create-a-summary-report-and-a-report-chart)
  * [Create a Dashboard](#step-3-create-a-dashboard)
7. [Summary](#summary)
